...
2. [] Add in level of sophistication of model either as RI or split data based on.
3. [] ANCOVA for probability of significance against n_obs, n_cov for each Tx, expect that slope of T3 is not zero. 
4. [] Add in extra treatment for Free T3 versus Total T3
5. [] Aggregate systems according to "atrial fibrillation (AF)[26-30], osteoporosis [31-35], and  cancer" (high tyroid function) and "steatohepatitis [39-41] and the features of the metabolic syndrome" (low thyroid function)
# Tuesday 11 Jun 2019
